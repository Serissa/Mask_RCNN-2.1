...
ROOT_DIR = os.getcwd()
if ROOT_DIR.endswith("samples/pig"):
...
class PigConfig(Config):
    ...
    NUM_CLASSES = 1 + 1  # Background + pig
...
def train(model):
    ...
    dataset_train.load_pig(args.dataset, "train")
    dataset_train.prepare()

    # Validation dataset
    dataset_val = PigDataset()
    dataset_val.load_pig(args.dataset, "val")
    dataset_val.prepare()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset',
                        default='D:/tensorflow/Mask_RCNN-2.1/samples/pig/dataset/',
                        help='Directory of the pig dataset')
    parser.add_argument('--weights',
                        default='coco',   # ''D:/tensorflow/Mask_RCNN-2.1/mask_rcnn_coco.h5',
