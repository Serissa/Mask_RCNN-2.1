...
# # Mask R-CNN - Inspect pig Training Data
# 
...
from samples.pig import pig_train



# ## Configurations
# 
# Configurations are defined in pig_train.py

# In[2]:


config = pig_train.PigConfig()
PIG_DIR = os.path.join(ROOT_DIR, "datasets/pig")
